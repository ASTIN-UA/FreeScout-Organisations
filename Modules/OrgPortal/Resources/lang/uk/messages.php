...
return [
    ...
    // Admin — email domains
    'domains'                     => 'Поштові домени',
    'domains_help'                => 'Клієнти, які пишуть із цих доменів, автоматично додаються до цієї організації. Публічні сервіси, як-от gmail.com, використовувати не можна.',
    'no_domains'                  => 'Доменів ще немає.',
    'add_domain'                  => 'Додати домен',
    'domain_placeholder'          => 'напр. company.com',
    'domain_added'                => 'Домен :domain додано.',
    'domain_removed'              => 'Домен :domain видалено. Його учасників збережено.',
    'domain_removed_with_members' => 'Домен :domain видалено. Деактивовано учасників: :count.',
    'domain_invalid'              => 'Введіть коректний домен, наприклад company.com.',
    'domain_public'               => ':domain — це публічний поштовий сервіс. Його прив’язка додасть до цієї організації сторонніх клієнтів і надасть їм доступ до заявок одне одного.',
    'domain_already_bound'        => 'Цей домен уже прив’язано до цієї організації.',
    'domain_taken'                => 'Цей домен уже прив’язано до організації «:org».',
    'domain_mailbox_conflict'     => 'Ці домени залишилися в попередній скриньці, оскільки нова вже їх використовує: :domains',
    'domain_delete_confirm'       => 'Видалити домен :domain? Нові клієнти з нього більше не додаватимуться автоматично.',
    'domain_delete_deactivate'    => 'Також деактивувати учасників, доданих автоматично за доменом :domain?' . "\n\n"
                                     . 'OK — деактивувати їх (вони втратять доступ до порталу).' . "\n"
                                     . 'Скасувати — залишити їх учасниками.',
    'member_source_auto'          => 'додано автоматично за доменом',
