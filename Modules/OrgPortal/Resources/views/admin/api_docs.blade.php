      ...
      "paths": {
        ...
        "/api/customers/{customerId}/organization": {
          ...
          "put": {
            ...
            "description": "Assigns a customer to an organization. If the customer already belongs to another organization, the membership is moved.",
            ...
            "responses": {
              "200": {
                ...
                "content": { "application/json": { "schema": { "$ref": "#/components/schemas/SuccessResponse" }, "example": { "success": true, "message": "Membership saved." } } }
              },
              "400": {
                "description": "Validation error",
                "content": { "application/json": { "schema": { "$ref": "#/components/schemas/ValidationError" } } }
