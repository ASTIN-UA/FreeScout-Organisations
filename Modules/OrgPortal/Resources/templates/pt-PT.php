<?php
/**
 * Default notification email templates — European Portuguese (pt-PT).
 *
...
return [
    ...
    'new_ticket' => [
        'subject' => 'Novo ticket {ticket_number} de {author_name}',
        'body'    =>
            '<div style="font-family:Arial,sans-serif;font-size:14px;color:#333;max-width:600px;">'
            . '<p>Olá, <strong>{manager_name}</strong>!</p>'
            . '<p>Um novo ticket de suporte foi submetido por um membro da sua organização <strong>{org_name}</strong>:</p>'
            ...
            .   '<tr><td style="color:#666;width:140px;padding:6px 0;">Assunto:</td>'
            ...
            . '<p style="margin-top:32px;font-size:12px;color:#999;">Recebeu este email porque ativou notificações para a sua organização no Portal do Cliente.</p>'
            . '</div>',
    ],
    ...
    'reply_agent' => [
        ...
        'body'    =>
            '<div style="font-family:Arial,sans-serif;font-size:14px;color:#333;max-width:600px;">'
            . '<p>Olá, <strong>{manager_name}</strong>!</p>'
            . '<p>Um agente de suporte respondeu a um ticket na sua organização <strong>{org_name}</strong>:</p>'
            . '<table style="width:100%;border-collapse:collapse;margin:16px 0;font-size:14px;">'
            ...
            .   '<tr><td style="color:#666;width:140px;padding:6px 0;">Ticket #:</td>'
            .       '<td style="padding:6px 0;">{ticket_number}</td></tr>'
            .   '<tr><td style="color:#666;width:140px;padding:6px 0;">Respondido em:</td>'
    ...
    'reply_customer' => [
        ...
        'body'    =>
            '<div style="font-family:Arial,sans-serif;font-size:14px;color:#333;max-width:600px;">'
            . '<p>Olá, <strong>{manager_name}</strong>!</p>'
            . '<p>Um cliente respondeu a um ticket na sua organização <strong>{org_name}</strong>:</p>'
            . '<table style="width:100%;border-collapse:collapse;margin:16px 0;font-size:14px;">'
            .   '<tr><td style="color:#666;width:140px;padding:6px 0;">De:</td>'
            .       '<td style="padding:6px 0;"><strong>{author_name}</strong> <span style="color:#999;font-size:12px;">({unit_name})</span></td></tr>'
            .   '<tr><td style="color:#666;width:140px;padding:6px 0;">Assunto:</td>'
