...
**Залежності:** [End-User Portal](https://freescout.net/module/end-user-portal/) *(опціонально)*  
...
### End-User Portal — розширений доступ для менеджерів *(опціонально)*
...
### Email-сповіщення
- Менеджери отримують email при створенні нового тікета будь-яким членом організації
...
|--------|--------|--------|
| End-User Portal | ≥ 1.0.85 | Опціональний |
| API and Webhooks | ≥ 1.0.80 | Опціональний |
| Kanban | ≥ 1.0.23 | Опціональний |
| Tags | будь-яка | Сумісний |
| Custom Fields | будь-яка | Сумісний |
| Workflows | будь-яка | Сумісний |
