...
Ta bort en medlem från organisationen. Blockerad om medlemmen har ärenden i den här organisationen — använd `PUT` med `isActive: false` istället för att inaktivera och bevara ärendehistoriken.
...
Tar endast bort kundens **aktiva** medlemskap. Historiska (inaktiverade) medlemskap i andra organisationer bevaras orörda. Blockerad om kunden har ärenden i den här organisationen — använd `PUT` med `isActive: false` istället för att inaktivera och bevara ärendehistoriken.
