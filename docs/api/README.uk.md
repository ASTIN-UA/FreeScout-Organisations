...
Видалення члена з організації. Заблоковано, якщо в учасника є заявки в цій організації — натомість використайте `PUT` з `isActive: false`, щоб деактивувати його і зберегти історію заявок.
...
Видаляє лише **активне** членство клієнта. Історичні (деактивовані) членства в інших організаціях залишаються недоторканими. Заблоковано, якщо в клієнта є заявки в цій організації — натомість використайте `PUT` з `isActive: false`, щоб деактивувати і зберегти історію заявок.
